                ...
                <div className="card-body">
                    ...
                    <form onSubmit={RegisterUser}>
                        ...
                        <div className="mb-3">
                            ...
                            <div className="my-input">
                                <div className="icono"><i className="bi bi-person"></i></div>
                                <input type="text" className="form-control" name="lastName" aria-describedby="emailHelp" />
                            </div>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="exampleInputEmail1" className="form-label">Correo electrónico</label>
                            <div className="my-input">
                                <div className="icono"><i className=" bi bi-envelope-fill"></i></div>
                                <input type="email" className="form-control" name="email" aria-describedby="emailHelp" />
                            </div>
                            <div id="emailHelp" className="form-text">Nunca compartiremos su informacion personal con nadie más</div>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="exampleInputPassword1" className="form-label">Contraseña</label>
                            <div className="my-input">
                                <div className="icono"><i className="bi bi-key"></i></div>
                                <input type="password" name="password" className="form-control" />
                            </div>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="exampleInputPassword1" className="form-label">Verificar Contraseña</label>
                            <div className="my-input">
                                <div className="icono"><i className="bi bi-key-fill"></i></div>
                                <input type="password" name="verify" className="form-control"/>
                            </div>
                        </div>
                        <div className="my-input">
                            <div className="icono"><i className="bi bi-person-circle"></i></div>
                            <select className="form-select" name="rol" aria-label="Default select example">
                        ...
                        <button type="submit" className="btn my-btn btn-primary">Enviar</button>
                    </form>
                </div>
            </div>
            {
